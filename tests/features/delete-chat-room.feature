...
Функционал: Возможность удаления переписок в чате
  Для того, чтобы пользоваться приложением now-i-am
  Как обычный пользователь
  Я должен иметь возможность удалить переписку
  ...
  Сценарий: Удаление переписок
    ...
    Допустим я кликаю на иконку со стилями ".chat-list-content__more-icon"
